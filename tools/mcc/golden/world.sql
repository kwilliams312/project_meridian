...
VALUES
  ('core', '0.1.0', 0, '3e3473d92a67d1affaab571b043a97fe79dfd2d26f392c511a926942ca26f45f', 1, 1, '0.0.0', '1970-01-01 00:00:00');
...
INSERT INTO ability (id, name, description, school, target, range_m, cast_time_ms, cast_channel_ms, cooldown_ms, triggers_gcd, resource_type, resource_amount, av_cast_anim, av_cast_vfx_id, av_cast_sfx_id, av_impact_vfx_id, av_impact_sfx_id, effects_json) VALUES
  ...
  (147, 'Immolation', 'Sets the target ablaze, searing them for {amount} fire damage each tick.', 'fire', 'enemy', 30, 0, NULL, 6000, TRUE, 'mana', 25, NULL, NULL, NULL, NULL, NULL, '[{"amount":{"max":9,"min":6},"coefficient":0.2,"duration_ms":12000,"kind":"dot","tick_ms":3000}]'),
  ...
  (152, 'Backstab', 'A precise thrust to a vital point for {amount} physical damage.', 'physical', 'enemy', 5, 0, NULL, 6000, TRUE, 'energy', 35, NULL, NULL, NULL, NULL, NULL, '[{"amount":{"max":28,"min":20},"coefficient":0.5,"kind":"damage"}]'),
  (153, 'Expose Armor', 'Finds the gaps in the target''s guard, weakening its armor.', 'physical', 'enemy', 5, 0, NULL, 10000, TRUE, 'energy', 25, NULL, NULL, NULL, NULL, NULL, '[{"amount":-40,"attribute":"core:attribute.armor","duration_ms":15000,"kind":"debuff","modifier":"flat"}]'),
  (154, 'Rend', 'A ragged cut that bleeds the target for {amount} damage each tick.', 'physical', 'enemy', 5, 0, NULL, 6000, TRUE, 'energy', 30, NULL, NULL, NULL, NULL, NULL, '[{"amount":{"max":8,"min":5},"coefficient":0.15,"duration_ms":12000,"kind":"dot","tick_ms":3000}]'),
  (155, 'Shadowstep', 'Blinks forward through the shadows, closing the gap.', 'shadow', 'self', 0, 0, NULL, 15000, FALSE, 'energy', 25, NULL, NULL, NULL, NULL, NULL, '[{"distance_m":15,"kind":"movement","motion":"dash"}]'),
  ...
  (157, 'Challenging Roar', 'A defiant bellow that seizes the target''s attention.', 'physical', 'enemy', 5, 0, NULL, 8000, TRUE, 'rage', 10, NULL, NULL, NULL, NULL, NULL, '[{"amount":500,"kind":"threat"}]'),
